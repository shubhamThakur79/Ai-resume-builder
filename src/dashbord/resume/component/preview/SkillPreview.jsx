...
const SkillPreview = ({ resumeInfo }) => {
    return (
        <div>
            ...
            <div id="skill" className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 w-[90%] mx-auto">
                {
                    resumeInfo?.skills?.map((skill, i) => (
                        <div id="data" className="flex flex-col flex-wrap items-start" key={i}>
                            {/* Skill Name */}
